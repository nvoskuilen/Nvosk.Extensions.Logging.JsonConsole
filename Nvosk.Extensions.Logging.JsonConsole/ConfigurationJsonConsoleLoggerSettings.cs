...
namespace Nvosk.Extensions.Logging.JsonConsole
{
    ...
    public class ConfigurationJsonConsoleLoggerSettings : IJsonConsoleLoggerSettings
    {
        private readonly IConfiguration _configuration;

        public ConfigurationJsonConsoleLoggerSettings(IConfiguration configuration)
        {
        ...
        {
            ChangeToken = null;
            return new ConfigurationJsonConsoleLoggerSettings(_configuration);
        }
